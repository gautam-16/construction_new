...
const {createUser, readUser,readOneUser,updateOneUser,deleteUser,loginUser,getRole,resetPassword,passswordSet}=require('../controller/user.controller')
...
router.route('/resetPassword/set').post(isAuthenticated,passswordSet)
